...
/*
    maxle: versuchsweise mal alles, was mit "mipi" zu tun hat weg...
*/
...
// maxle: added xga, sxga etc.  present in 3.0.35 but removed here...
...
static void mxc_hdmi_edid_rebuild_modelist(struct mxc_hdmi *hdmi)
{
	...
	//maxle: change default mode from 640x480 to 1280x1024. It works for me.
...
static void  mxc_hdmi_default_modelist(struct mxc_hdmi *hdmi)
{
	...
	console_unlock();
	dev_info(&hdmi->pdev->dev, "maxle: create default modelist done\n");
}
...
//      edid_status = HDMI_EDID_NO_MODES; /* maxle test workaround */
//===============================================================
